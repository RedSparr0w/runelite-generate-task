...
public class AchievementDiaryMapping {
    ...
    static {
        ...
        DIARY_MAPPING.put("kourend & kebos_easy", new DiaryInfo(VarbitID.KOUREND_DIARY_EASY_COMPLETE, 1, "kourend & kebos", "easy"));
        DIARY_MAPPING.put("kourend & kebos_medium", new DiaryInfo(VarbitID.KOUREND_DIARY_MEDIUM_COMPLETE, 1, "kourend & kebos", "medium"));
        DIARY_MAPPING.put("kourend & kebos_hard", new DiaryInfo(VarbitID.KOUREND_DIARY_HARD_COMPLETE, 1, "kourend & kebos", "hard"));
        DIARY_MAPPING.put("kourend & kebos_elite", new DiaryInfo(VarbitID.KOUREND_DIARY_ELITE_COMPLETE, 1, "kourend & kebos", "elite"));
        DIARY_MAPPING.put("lumbridge & draynor_easy", new DiaryInfo(VarbitID.LUMBRIDGE_DIARY_EASY_COMPLETE, 1, "lumbridge & draynor", "easy"));
        DIARY_MAPPING.put("lumbridge & draynor_medium", new DiaryInfo(VarbitID.LUMBRIDGE_DIARY_MEDIUM_COMPLETE, 1, "lumbridge & draynor", "medium"));
        DIARY_MAPPING.put("lumbridge & draynor_hard", new DiaryInfo(VarbitID.LUMBRIDGE_DIARY_HARD_COMPLETE, 1, "lumbridge & draynor", "hard"));
        DIARY_MAPPING.put("lumbridge & draynor_elite", new DiaryInfo(VarbitID.LUMBRIDGE_DIARY_ELITE_COMPLETE, 1, "lumbridge & draynor", "elite"));
